package com.vomiter.beneathdelight.adapter;
...
public interface INetherStoveBlockEntity {
    int[] sdtfc$getCookingTimes();
    int[] sdtfc$getCookingTimesTotal();
    NetherStoveBlockEntity sdtfc$getBlockEntity();
    ...
    default boolean sdtfc$addItem(ItemStack itemStackIn, int slot, INetherStoveBlockEntity stove, Player player) {
    ...
    default void sdtfc$ejectItem(INetherStoveBlockEntity stove, ItemStack item){
        Level level = stove.sdtfc$getBlockEntity().getLevel();
    ...
    default void sdtfc$cookTFCFoodInSlot(INetherStoveBlockEntity stove, int slot){
        var inventory = stove.sdtfc$getInventory();
        Level level = stove.sdtfc$getBlockEntity().getLevel();
        BlockPos pos = stove.sdtfc$getBlockEntity().getBlockPos();
        if(level == null) return;
